...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(item){
     return arrayNames.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
    });
  return arrayNames
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowercased = array.map(function(array) {
  ...
  */
  ...
  function lowPopulationAnimals(cb){
    const lowPop = cb.filter(function(item){
      return item.population < 5;
    })
    return lowPop
  }
  console.log(lowPopulationAnimals(animalNames(zooAnimals)));
  ...
  */
  ...
  function USApop(array){
    const usaPopulation = array.reduce(function(accumulator, item){
...
function CubeMaker(param){
  CuboidMaker.call(this, param)
}
...
console.log('strech', cube.volume())
console.log('strech', cube.surfaceArea())
